...
**Offen (braucht Yasin):** **Backbone One PS (B0CT17GPNT)** wurde bewusst nicht aktualisiert. Das Listing zeigt keinen Preis, heißt "iPhone (Lightning) 1st Gen" und die 16.951 Bewertungen gehören zur gesamten Varianten-Familie, nicht zu dieser Variante. Lightning ist für iPhone 15+ obsolet. Entscheidung nötig: Produkt behalten (dann mit welchem Beleg?), auf die aktuelle Variante umstellen oder auslisten.
